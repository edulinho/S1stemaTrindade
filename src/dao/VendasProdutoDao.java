...
public class VendasProdutoDao extends DAO_Abstract{
    ...
    public Object list(int id) {
        session.beginTransaction();
        Criteria criteria = session.createCriteria(EtsVendasProduto.class); //importar do bean e do hibernate; criteria é pra fazer select * from na O.O
        criteria.add(Restrictions.eq("ets_id_vendas_produto", id)); //é um método estático; id é o parametro da linha 46
